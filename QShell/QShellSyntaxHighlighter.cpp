...
QShellSyntaxHighlighter::QShellSyntaxHighlighter(QTextDocument *parent)
	: QSyntaxHighlighter(parent)
{
	...
	keywordPatterns << "\\bvar\\b" << "\\bArray\\b" << "\\bfunction\\b"
		...
		<< "\\bcase\\b" << "\\bbreak\\b" << "\\bwhile\\b" << "\\bnumber\\b"
		<< "\\bstring\\b" << "\\bobject\\b" << "\\bboolean\\b";
	...
	trueFalseFormat.setForeground(Qt::blue);
...
void QShellSyntaxHighlighter::highlightBlock(const QString &text)
{
